...
@class EDAMNotFoundException, EDAMSystemException, EDAMUserException, NSMutableArray;

@interface EDAMListSharedNotebooks_result : _AVAudioSessionCategoryPlayback <NSCoding>
{
...
- (id)initWithSuccess:(id)fp8 userException:(id)fp12 notFoundException:(id)fp16 systemException:(id)fp20;
- (id)init;

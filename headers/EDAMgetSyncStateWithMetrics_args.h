...
@interface EDAMgetSyncStateWithMetrics_args : _AVAudioSessionCategoryPlayback <NSCoding>
{
...
- (id)initWithAuthenticationToken:(id)fp8 clientMetrics:(id)fp12;
- (id)init;

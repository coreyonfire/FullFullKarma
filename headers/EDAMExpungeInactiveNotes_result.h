...
@interface EDAMExpungeInactiveNotes_result : _AVAudioSessionCategoryPlayback <NSCoding>
{
    int __success;
...
- (id)initWithSuccess:(int)fp8 userException:(id)fp12 systemException:(id)fp16;
- (id)init;

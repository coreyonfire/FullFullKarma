...
@interface EDAMexpungeNotes_args : _AVAudioSessionCategoryPlayback <NSCoding>
{
...
- (id)initWithAuthenticationToken:(id)fp8 noteGuids:(id)fp12;
- (id)init;

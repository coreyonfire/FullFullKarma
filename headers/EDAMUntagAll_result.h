...
@interface EDAMUntagAll_result : _AVAudioSessionCategoryPlayback <NSCoding>
{
...
- (id)initWithUserException:(id)fp8 systemException:(id)fp12 notFoundException:(id)fp16;
- (id)init;

...
@interface EDAMfindNotes_args : _AVAudioSessionCategoryPlayback <NSCoding>
{
...
- (id)initWithAuthenticationToken:(id)fp8 filter:(id)fp12 offset:(int)fp16 maxNotes:(int)fp20;
- (id)init;
